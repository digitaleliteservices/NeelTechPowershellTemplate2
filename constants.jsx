...
export const TRANSLATIONS = {
  en: {
    ...
    nav_faq: "FAQs",
    hero_badge: "AWS SAA-C03 Certified Course",
    hero_title: "POWERSHELL Training Certification Course for Solutions Architect",
    hero_sub: "Master professional PowerShell automation and AWS Solutions Architecture with intensive, hands-on labs designed for the modern cloud landscape.",
