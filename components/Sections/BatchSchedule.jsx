  ...
  const modes = [
    ...
    },
    {
      ...
      features: [
        ...
        "2 Month Live Instructor-led",
        "Interactive Real-time Labs",
    ...
    <section id="batches" className="py-24 bg-lightCream">
      <div className="container mx-auto max-w-[1280px] px-6">
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-heading font-extrabold text-deep tracking-tight">
            Investment Plans
          </h2>
          <p className="mt-5 text-deep/60 max-w-2xl mx-auto text-lg">
            Premium training modes designed to fit your unique professional
            schedule and career velocity.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-heading font-extrabold text-deep">
                      {mode.title}
                    </h3>
                    <span className="text-[10px] text-secondary font-extrabold uppercase tracking-widest">
                      {mode.bestFor}
                    </span>
                  </div>
                </div>
                {mode.originalPrice && (
                  <div className="bg-success/10 text-success text-[10px] font-black px-2 py-1 rounded">
                    30% OFF
                  </div>
                )}
              </div>
              ...
              <div className="mb-10">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-heading font-extrabold text-deep tracking-tighter">
                    {mode.price}
                  </span>
                  {mode.price.includes("₹") && (
                    <span className="text-deep/40 text-sm font-bold">
                      incl. taxes
                    </span>
                  )}
                </div>
              ...
              <ul className="space-y-5 mb-12 flex-grow">
                {mode.features.map((feature, fIdx) => (
                  <li
                    key={fIdx}
                    className="flex items-start gap-4 text-sm text-deep/70 font-medium leading-tight"
                  >
                    <CheckCircle2
                      size={18}
              ...
              <div className="block w-full">
                ...
                <Button
                  variant={mode.recommended ? "primary" : "outline"}
                  className="w-full h-[56px] text-lg flex items-center justify-center gap-2"
                ...
                >
                  ...
                  <span className="text-green-400 font-bold">₹39</span>
                </Button>
              </div>
            </div>
          ))}
        ...
        <div className="mt-20 p-10 bg-deep rounded-card shadow-premium flex flex-col md:flex-row items-center justify-between gap-8 border-t-8 border-accent">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h4 className="font-heading font-extrabold text-white/50 uppercase tracking-[0.2em] text-[10px] mb-1">
                Upcoming Cohort
              </h4>
          ...
          <div className="flex flex-col md:items-end gap-3 text-center md:text-right">
            <p className="text-white font-bold">
              Limited Enrollment:{" "}
              <span className="text-accent">Only 4 seats left</span>
            </p>
